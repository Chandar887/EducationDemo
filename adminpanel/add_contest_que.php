...
$q = "SELECT * FROM `quiz_contest` ORDER BY id DESC";
...
//                print_r($catq);die;
                ...
                <form class="border rounded p-4 submitform" action="controller/quiz_controller.php" method="post">
                    ...
                    <div class="form-group">
                        <input type="hidden" name="contest_id" value="<?php echo $data['id']; ?>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <button type="submit" name="submit" value="add_contest_question" class="btn btn-primary btn-block button_submit">Submit</button>           
