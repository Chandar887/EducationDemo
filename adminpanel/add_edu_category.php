...
<?php
if (isset($_SESSION['cat_inserted']) || isset($_SESSION['checkCat']) || isset($_SESSION['cat_updated']) || isset($_SESSION['checkparentt'])) {
...
//        delete parent category with sub categories
