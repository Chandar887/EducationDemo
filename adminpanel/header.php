        ...
        <nav class="navbar navbar-dark sticky-top navbar-expand-md bg-primary flex-md-nowrap py-0">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo $apage == 'franchise' ? 'active' : ''; ?>" href="page-franchiselist.php">
                            <i class="pr-2 fa fa-users"></i>Franchises
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <!--                    <li class="nav-item">
                                            <a class="nav-link <?php echo $apage == 'coinsrequest' ? 'active' : ''; ?>" href="page-coins-request.php">
                                                <i class="pr-2 fa fa-coins"></i>Coins Request
                                            </a>
                                        </li>-->
                    <li class="nav-item">
                        <a class="nav-link <?php echo $apage == 'withdraw' ? 'active' : ''; ?>" href="page-withdraw.php">
                            <i class="pr-2 fa fa-coins"></i>Withdraw
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?php echo $apage == 'gameplay' ? 'active' : ''; ?>" href="page-gameplay.php">
                            <i class="pr-2 fa fa-play"></i>Gameplay
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle <?php echo $apage == "viewcontest" || $apage == 'newcontest' || $apage == 'viewquestions'|| $apage == 'addquestion'  ? 'active' : ''; ?>" id="navDropDownLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="pr-1 fa fa-question"></i>Quiz
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navDropDownLink">
                            ...
                            <a class="dropdown-item" href="add_contest.php">Add Contest</a>

                            <a class="dropdown-item" href="view_all_contest.php">View All Contests</a>
                             <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="add_questions.php">Add Questions</a>
                            <a class="dropdown-item" href="view_all_questions.php">View All Questions</a>
                        </div>
...
<!--                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle <?php echo $apage == 'viewquestions' || $apage == 'addquestion' ? 'active' : ''; ?>" id="navDropDownLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="pr-1 fa fa-question"></i>Questions
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navDropDownLink">
                            <a class="dropdown-item" href="page-profile.php">Profile</a>
...
<!--                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle <?php // echo $apage == 'viewexamcontest' || $apage == 'addexamcontest' ? 'active' : ''; ?>" id="navDropDownLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="pr-1 fa fa-tasks"></i>Exams
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navDropDownLink">

                            <a class="dropdown-item" href="add_exam_contest.php">Add Exam Contest</a>
                            <a class="dropdown-item" href="view_exam_contest.php">View Exam Contest</a>
                        </div>

                    </li>-->

                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle <?php echo $apage == 'testaddcategory' || $apage == 'testaddquestion' || $apage == 'testquestiondetails' || $apage == 'updatetestque' || $apage == 'viewtestquestions' || $apage == 'addnewtest' || $apage == 'viewalltest' ? 'active' : ''; ?>" id="navDropDownLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="pr-1 fa fa-tasks"></i>Practice Test
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navDropDownLink">
                            <a class="dropdown-item" href="add_new_test.php">Add New Test</a>
                            <a class="dropdown-item" href="test_add_category.php">Add Category</a>
                            <a class="dropdown-item" href="test_question_details.php">Add Questions</a>
                            <a class="dropdown-item" href="view_all_test.php">View All Tests</a>
                            <a class="dropdown-item" href="test_view_questions.php">View Questions</a>
                        </div>
                    </li>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <?php
                //Create Sponsor Downline
//                if ($userd = $db->selectRows("w_users")) {
//                    foreach ($userd as $uu) {
//                        user_downline_sponsor($db, $uu['sponsorID'], $uu['ID']);
//                    }
//                }
                ?>