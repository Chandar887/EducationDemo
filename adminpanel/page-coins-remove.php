...
<main role="main" class="col-md-12 pt-3">
    ...
    <div class="col-12 col-md-8 mx-auto">
        <form class="border rounded p-4 submitform" action="controller/controller.php" method="post" enctype="multipart/form-data">
            <p class="h4">Enter Coins For receive</p>
            <?php
            ...
            <div class="form-group mb-4">
                ...
                <select id="review" name="review" class="form-control" required>
                    ...
                    <option value="resultsettlement">Settlement</option>
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" id="coins" name="uCoin" min="1" step="1" class="form-control U_coin" data-id='<?php echo $uData['uMobile'] ?>' placeholder="Coin Amount *" value="<?php echo isset($request["coin"]) ? number_format($request["coin"]) : '10'; ?>" <?php echo isset($request["coin"]) ?"readonly":"";?> required>
            </div>
            <div class="form-group mb-4">
            ...
            <div class="form-group">
                <button type="submit" name="submit" value="withdrawCoins" class="btn btn-primary btn-block button_submit">Withdraw</button>
            </div>
        </form>
    </div>
</main>
