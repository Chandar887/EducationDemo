...
<main role="main" class="col-md-12 pt-3">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        <h2 class="h2"><i class="fa fa-users"></i> Franchise</h2>
...
<!--                            <td><?php echo $d['uCoin'] ?></td>
                            ...
                            <td class="text-right">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="page-userlist.php?franchiseID=<?php echo $d['ID'] ?>" class="btn btn-warning" title="Users" target="_blank"><i class="fas fa-network-wired"></i></a>
                                    <a href="page-franchisedetail.php?franchiseID=<?php echo $d['ID'] ?>" class="btn btn-primary" title="Edit" target="_blank"><i class="fas fa-eye"></i></a>
                                </div>
                            </td>
                        </tr>
                        <?php
