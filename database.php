...
if (in_array($_SERVER['REMOTE_ADDR'], array('127.0.0.1', '::1'))) {
    $db = new database('localhost', 'root', '', 'educationdemo');
    $db->slash = "\\";
    $db->root = __DIR__ . $db->slash;
    $db->site = 'http://localhost/EducationDemo/';
} else {
   $db = new database('localhost', 'ludobus1_edudemo', 'XqAcD3N7ctW9', 'ludobus1_edudemo');
