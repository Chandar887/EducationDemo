...
//    {
//       $db->redirect($db->site."educationpanel/index.php");
//    }
//}
include_once("controller/userClass.php");

if (isset($_REQUEST['uToken'])) {
    $token = $_REQUEST['uToken'];
            ...
            <div class="container-fluid">
                <div class="row p-1">
                    <div class="col-6 col-sm-8">
                        ...
                        <a href="index.php" style="font-size: 20px; background-color: #007bff;padding: 12px 8px 10px 8px;color: white;"><b>Education</b></a>
                    ...
                    <div class="col-6 col-sm-4"> 
                        <!--                         <div class="header-top-menu"> 
                                                 <a href="controller/logout.php?type=logout" class="btn pull-right signout"><i class="fa fa-sign-out"></i>Sign Out</a> 
                                                 </div> 
                                                 Example single danger button -->
                        <div class="btn-group pull-right">
                            <a href="live-class.php" class="text-success mt-1">
                                LIVE
                            </a> 
