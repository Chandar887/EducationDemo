...
$selectCatname = $db->selectQuery("select * from live_class_data where id = '$live_class_id'");
...
//  else
//  {
        $q = "SELECT * FROM `live_class_que` WHERE live_class_id = '$live_class_id'";
        $result = mysqli_query($db->con, $q);
...
//                $total_mem = $data['total_member'];
            $prog = mysqli_query($db->con, "SELECT * FROM `live_class_data` WHERE id = '$live_class_id'");
...
//                $spots = $total_mem - $count['count'];
            ...
            <form id="submit_quiz1" action="controller/edu_controller.php" method="post">
                <div class="row">
                    <?php
//                    $test = true;
                    $x = 1;
...
//                        $test = false;
                        ...
                        <div class="col-lg-6 col-md-6 col-12 mt-3 question q<?php echo $x; ?> <?php echo ($x != 1 ? "d-none" : ""); ?>" data-question="<?php echo $x; ?>">
                            <div class="card" style="max-width: 100%; height: 100%;">
                                ...
                                <ul class="list-group list-group-flushs donate-now">
                                    ...
                                    <input type="hidden" name="contest_id" value="<?php echo $live_class_id; ?>">
        ...
        $q = "SELECT * FROM `live_class_data` WHERE id = '$live_class_id'";
