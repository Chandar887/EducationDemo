...
<section>
    <div class="col-12 mt-3">
        ...
        <div class="text-white vbook rounded" vbook="vbook" style="background-color: #007bff; outline: solid 8px #005bbd; outline-offset: -15px;">
...
?>
        ...
        if (!isset($_GET['subjct_name'])) {
            ?>
                        window.location = "lessons.php?sub_category=" + sub_category + "& subject_name=" + subject_name + "& type=" + type + "& parent=" + parent;
            <?php
        } else {
            ?>
                        window.location = "lessons.php?sub_category=" + subject_name + "& subject_name=" + subject_name + "& type=" + type + "& parent=" + parent;
            <?php
        }
        ?>
