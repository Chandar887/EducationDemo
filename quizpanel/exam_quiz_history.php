...
<div class="container">
    <!--<div class="col-md-4 col-12">-->
     <div class="rounded mt-3" style="border-left: 10px solid #007bff; background-color: #b4b5b545;">
            <h5 class="text-center my-auto p-1"><b>Exam Quiz History</b></h5>
        </div>
...
//        echo "SELECT * FROM `quiz_score` where user_id = '$user_id' ORDER BY id DESC";
    ...
    if (mysqli_num_rows($quiz_q) > 0) {
        ...
        while ($quiz_data = mysqli_fetch_array($quiz_q)) {
            ...
            if ($quiz_data['exam_id'] != "") {
                $contest_ids = $quiz_data['exam_id'];
                    ...
                    <div class="card-body view_rank" contest-id="<?php echo $contest_ids; ?>">
                        <div class="col-12">
                            <div class="row">
                                ...
                                <p class="card-text text-secondary cardp"><?php echo $quiz_qdata['category_name']; ?></p>
                            ...
                            <div class="row">  
                                ...
                                <p class="card-text text-dark"><?php echo $quiz_qdata['contest_name']; ?></p>
