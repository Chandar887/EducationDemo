...
<div class="container">
    ...
    <div class="col-lg-6 col-md-4 col-12 mt-2 p-0">
        ...
        if (isset($_GET['contest_id'])) {
            ...
            $data = mysqli_fetch_assoc(mysqli_query($db->con, "SELECT * FROM `quiz_contest` where id = '$contest_id'"));
            ?>
...
//                        $test = false;
        ...
        <table class="table mt-3">
            ...
            <?php
            $x = 0;
            $rankqqq = mysqli_query($db->con, "SELECT * FROM `quiz_play_detail` WHERE contest_id = '$contest_id' ORDER BY score DESC,complete_time ASC");
