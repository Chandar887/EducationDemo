...
//    echo basename($_SERVER['PHP_SELF']);die;
    if (!(isset($_SESSION['stop_back']) && $_SESSION['stop_back'] == 1)) {
        $db->redirect($db->site . "testpanel/index.php");
    }
}
...
<html class="no-js" lang="">
    ...
    <head>
        ...
        <meta name="description" content="Webcyst Demo">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-6 col-sm-8">
                       ...
                       <a href="index.php" style="font-size: 20px; background-color: #007bff;padding: 8px 6px 6px 6px;color: white;"><b>Model Test</b></a>
                    ...
                    <div class="col-6 col-sm-4"> 
                        ...
                        <div class="btn-group pull-right">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" title="Quiz History" href="test_history.php"><i class="fa fa-history text-primary mr-2"></i>Test History</a>
